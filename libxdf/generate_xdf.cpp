...
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeDataChunkFloat(
        JNIEnv *env,
        jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeDataChunkInt(
        JNIEnv *env,
        jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeDataChunkDouble(
        JNIEnv *env,
        jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeDataChunkByte(
        JNIEnv *env,
        jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeDataChunkShort(
        JNIEnv *env,
        jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeDataChunkStringMarker(
        JNIEnv *env,
        jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeStreamOffset(
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeStreamHeader(
        JNIEnv *env, jclass clazz,
        jstring filename,
...
extern "C"
JNIEXPORT void JNICALL
Java_de_uol_neuropsy_recorda_xdf_XdfWriter_writeStreamFooter(
        JNIEnv *env, jclass clazz,
        jstring filename,
        jint stream_index, // zero-based
        jstring footer_xml
